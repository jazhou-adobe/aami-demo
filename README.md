...
## Environments
- Preview: https://main--aami-demo--jazhou-adobe.hlx.page/
- Live: https://main--aami-demo--jazhou-adobe.hlx.live/
...
1. Open the `aami-demo` directory in your favorite IDE and start coding :)
